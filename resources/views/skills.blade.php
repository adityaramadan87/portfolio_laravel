    ...
    <aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
        ...
        <nav id="colorlib-main-menu" role="navigation">
            <ul>
                ...
                <li class="colorlib-active"><a href="{{url('skills')}}">Skills</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text justify-content-center align-items-center">
                <div class="col-md-8 ftco-animate">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{url('')}}">Home</a></span> <span>Skills</span></p>
            ...
            <div class="row">
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block">
                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/android.png')}}); width: 100px; height: 100px;"></span>
                        <div class="media-body p-2 mt-2">
                            <h3 class="heading mb-3">Android</h3>
                            <p>Making Android app use Android Studio with java language, can get API, connect to firebase etc</p>
                        </div>
                    </div>
                </div>
{{--                <div class="col-md-4 d-flex align-self-stretch ftco-animate">--}}
{{--                    <div class="media block-6 services py-4 d-block">--}}
{{--                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/apple.png')}}); width: 100px; height: 100px;"></span>--}}
{{--                        <div class="media-body p-2 mt-2">--}}
{{--                            <h3 class="heading mb-3">IOS</h3>--}}
{{--                            <p>Making IOS app with Swift Language use Xcode</p>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block">
                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/flutter.png')}}); width: 100px; height: 100px;"></span>
                        <div class="media-body p-2 mt-2">
                            <h3 class="heading mb-3">Flutter</h3>
                            <p>Making Android or IOS app with flutter in Visual Studio Code with dart language</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block">
                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/web.png')}}); width: 100px; height: 100px;"></span>

                        <div class="media-body p-2 mt-2">
                            <h3 class="heading mb-3">Web or Web Service</h3>
                            <p>Making Web or Web Service with Html, Php(laravel, Code Igniter),GO. Can make RESTful API </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-sel Searchf-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block">
                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/uiux.png')}}); width: 100px; height: 100px;"></span>
                        <div class="media-body p-2 mt-2">
                            <h3 class="heading mb-3">UI/UX</h3>
                            <p>Making Design For Web or Mobile app use Adobe Illustrator or Figma.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services py-4 d-block">
                        <span class="photography-entry img image-popup d-flex justify-content-start align-items-end" style="background-image: url({{asset('app-assets/images/softskills.png')}}); width: 100px; height: 100px;"></span>
                        <div class="media-body p-2 mt-2">
                            <h3 class="heading mb-3">Soft Skill</h3>
                            <p>Public Speaking, Leadership and Teamwork</p>
                        </div>
                    </div>
                </div>
            </div>
